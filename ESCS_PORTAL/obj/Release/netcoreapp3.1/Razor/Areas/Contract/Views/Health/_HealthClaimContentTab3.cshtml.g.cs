#pragma checksum "D:\project\ESCS_PORTAL\ESCS_PORTAL\Areas\Contract\Views\Health\_HealthClaimContentTab3.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c3b7944a717db27dc683ae5deab36c19dd1c4b83"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c3b7944a717db27dc683ae5deab36c19dd1c4b83", @"/Areas/Contract/Views/Health/_HealthClaimContentTab3.cshtml")]
                    ...
                    <div class=""row card-header"">
                        <div class=""row"">
                            <div class=""col-12 text-center"">
                                <h3>Thông tin người thông báo/ liên hệ </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class=""row mt-3"">
                            ...
                            <div class=""col-12 mt-3"">
                                <div class=""custom-control custom-checkbox"">
                                    <input class=""custom-control-input"" ty");
            WriteLiteral(@"pe=""checkbox"" id=""chkThamGiaLienHe"" value=""option1"">
            ...
            WriteLiteral(@" maxlength=""100"" name=""nguoi_lh"" placeholder=""VD: Nguyễn Văn A"">
                            ...
                            <div class=""col-6"">
                                <div class=""form-group"">
                                    ...
                                    <select class=""select"" name=""nguoi_lhla"">
                                        <option");
        ...
        ");
                    ...
                    <div class=""row card-body"" style=""height:55vh; overflow:auto"">
                        <div class=""col-12"">
                            <div class=""row"" style=""margin-top:5px;"">
                                <div class=""col-6"">
                                    <label class=""form-");
            WriteLiteral(@"label"">Nguyên nhân</label>
                                ...
                                <div class=""col-6"">
                                    <label class=""form-label"">Hình thức điều trị</label>
                                    <select class=""select"" id=""hinh_thuc"" name=""hinh_thuc""></select>
            ...
            WriteLiteral(@">Ngày vào viện</label>
                                    <div class=""form-outline datepicker"" data-mdb-inline=""true"" data-mdb-format=""dd/mm/yyyy"">
                                        <input type=""text"" class=""form-control"" name=""ngay_vv"" value-format=""number"" placeholder=""ngày vào viện"" />
                                    </div>
                                </div>
                                <div class=""col-6"">
                                    <label");
            ...
            EndWriteAttribute();
            WriteLiteral(@">Ngày ra viện</label>
                                    <div class=""form-outline datepicker"" data-mdb-inline=""true"" data-mdb-format=""dd/mm/yyyy"">
                                        <input type=""text"" class=""form-control"" name=""ngay_rv"" value-format=""number"" placeholder=""ngày ra viện"" />
                                    </div>
                                </div>
                            </div>
            ...
            EndWriteAttribute();
            WriteLiteral(@">Ngày xảy ra</label>
                                    <div class=""form-outline datepicker"" data-mdb-inline=""true"" data-mdb-format=""dd/mm/yyyy"">
                            ...
                            <div class=""row mt-3 d-none tai_nan"">
                                <div class=""col-6"">
                                    ...
                                    <input type=""text""");
            WriteLiteral(@" autocomplete=""off"" class=""form-control email-inputmask"" maxlength=""100"" name=""nguyen_nhan_tnan"" placeholder=""Nguyên nhân"">
                                </div>
                                <div class=""col-6"">
            ...
            WriteLiteral(@"              <div class=""row mt-3"">
                                <div class=""col-12"">
                                    ...
                                    <select class=""select"" id=""benh_vien"" name=""benh_vien""></select>
                            ...
                            <div class=""row mt-3"">
                                <div class=""col-12"">
                                    ...
                                    <input type=""text"" autocomplete=""off"" class=""form-control email-inputmask"" maxlength=""100"" name=""chan_doan"" placeholder=""Chẩn đoán"">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            WriteLiteral(@"      <div class=""col-12"">
                ...
                <div class=""col-12 col-md-4 col-xxl-4"" style=""padding:0px 20px 0px 20px"" id=""khaiBaoHoSoBTTab3"">
                    <div class=""row card-header"">
                        <div class=""row"">
                            <div class=""col-12 text-center"">
                                <h3>Thông tin thụ hưởng bảo hiểm </h3>
                            </div>
       ");
            WriteLiteral(@"                 </div>
                    </div>
                    <div class=""row card-body"" style=""height:55vh; overflow:auto"">
                        <div class=""row mt-3"">
                            <div class=""col-12"">
                                <label class=""form-label"">Họ tên người thụ hưởng</label>
                                <input type=""text"" autocomplete=""off"" class=""form-control email-inputmask"" maxlength=""100"" name=""thu_huong_ten"" placeholder=""Tên người thụ hưởng"">
                            </div>
                        </div>
                        <div class=""row mt-3"">
                            <div class=""col-12"">
                                <label class=""form-label"">Số tài khoản</label>
                                <input type=""text"" autocomplete=""off"" class=""form-control email-inputmask"" maxlength=""100"" name=""thu_huong_tk"" placeholder=""Số tài khoản thụ hưởng"">
                            </div>
                        </div>
                       ");
            WriteLiteral(@" <div class=""row mt-3"">
            ...
            WriteLiteral(@"ol-12"">
                                ...
                                <input type=""text"" autocomplete=""off"" class=""form-control email-inputmask number"" maxlength=""100"" name=""tien_yc"">
                            </div>
                        </div>
                    </div>
                    <div class=""row card-footer mt-3"">
                        <div class=""col-12"">
                            ...
                            <button type=""button"" class=""btn btn-md btn-primary btn-tab-3"" onclick=""OnTiepTheo('tab_3')"" style=""float: right"">
                                Mở hồ sơ <i class=""fas fa-chevron-right ml-2""></i>
                            </button>
                        </div>
                    </div>
   ");
